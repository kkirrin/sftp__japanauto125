...
<body class="wrapper">
    ...
    <div>
        <header class="z-10 w-full md-28 transition-colors py-4">
            <div class="container md:gap-5 items-center flex md:pt-2">
                <div class="pt-4 relative w-full z-10 flex items-center md:justify-between justify-between gap-5">

                    <!--  Лево -->
                    <div class="btn__menu md:flex hidden h-full">
                    ...
                    <!--  Центр -->
                    <a href="/"><img class="m-auto md:hidden block md:w-[200px] sm:w-[128px] w-[120px]" src="<?php echo get_template_directory_uri() . '/src/img/icons/logo__black.svg'; ?>" alt="Logo"></a>

                    <div>
                        <ul class="hidden md:flex gap-5 justify-center items-center z-100">
                            <li class="mr-1">
                                <a href="/">
                    ...
                    <div class="flex">
                        <ul class="flex md:gap-4 gap-2 clip ">
